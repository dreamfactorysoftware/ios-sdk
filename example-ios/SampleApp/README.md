...
From the Apps menu in the DreamFactory Admin Console, click import and import the package from "https://raw.github.com/dreamfactorysoftware/app-address-book-ios/master/add_ios.dfpkg". Set the storage service to local file storage and the storage container to applications. Click the Update button when done.
...
### Examples of log in and registration: 
  - [MasterViewController](https://github.com/dreamfactorysoftware/ios-sdk/blob/master/example-ios/SampleApp/MasterViewController.m#L82-L127)
  - [RegisterViewController](https://github.com/dreamfactorysoftware/ios-sdk/blob/master/example-ios/SampleApp/RegisterViewController.m#L52-L97)
``` Objective-C
...
#####all records in table: 
  - [AddressBookViewController](https://github.com/dreamfactorysoftware/ios-sdk/blob/master/example-ios/SampleApp/AddressBookViewController.m#L125-L178)
```Objective-C
...
#####with fields: 
  - [GroupAddViewController](https://github.com/dreamfactorysoftware/ios-sdk/blob/master/example-ios/SampleApp/GroupAddViewController.m#L310-L403)
```Objective-C
...
#####with filter: 
  - [GroupAddViewController](https://github.com/dreamfactorysoftware/ios-sdk/blob/master/example-ios/SampleApp/GroupAddViewController.m#L592-L638)
  - [ContactViewController](https://github.com/dreamfactorysoftware/ios-sdk/blob/master/example-ios/SampleApp/ContactViewController.m#L399-L470)
``` Objective-C
...
#####with relation: 
  - [ContactListViewController](https://github.com/dreamfactorysoftware/ios-sdk/blob/master/example-ios/SampleApp/ContactListViewController.m#L333-L490)
  - [ContactViewController](https://github.com/dreamfactorysoftware/ios-sdk/blob/master/example-ios/SampleApp/ContactViewController.m#L560-L637)
``` Objective-C
...
#####single record:
  - [ContactEditViewController](https://github.com/dreamfactorysoftware/ios-sdk/blob/master/example-ios/SampleApp/ContactEditViewController.m#L616-L665)
  - [GroupAddViewController](https://github.com/dreamfactorysoftware/ios-sdk/blob/master/example-ios/SampleApp/GroupAddViewController.m#L543-L562)
``` Objective-C
...
#####multiple records:
  - [ContactEditViewController](https://github.com/dreamfactorysoftware/ios-sdk/blob/master/example-ios/SampleApp/ContactEditViewController.m#L674-L724)
``` Objective-C
// build request body
...
#####records with references:
  - [ContactEditViewController](https://github.com/dreamfactorysoftware/ios-sdk/blob/master/example-ios/SampleApp/ContactEditViewController.m#L297-L361)
  - [GroupAddViewController](https://github.com/dreamfactorysoftware/ios-sdk/blob/master/example-ios/SampleApp/GroupAddViewController.m#L407-L453)
  
#####single record: 
  - [GroupAddViewController](https://github.com/dreamfactorysoftware/ios-sdk/blob/master/example-ios/SampleApp/GroupAddViewController.m#L412-L450)
  - [ContactEditViewController](https://github.com/dreamfactorysoftware/ios-sdk/blob/master/example-ios/SampleApp/ContactEditViewController.m#L370-L410)
``` Objective-C
...
#####multiple records:
  - [ContactEditViewController](https://github.com/dreamfactorysoftware/ios-sdk/blob/master/example-ios/SampleApp/ContactEditViewController.m#L420-L498)
  - [GroupAddViewController](https://github.com/dreamfactorysoftware/ios-sdk/blob/master/example-ios/SampleApp/GroupAddViewController.m#L469-L529)
``` Objective-C
NSMutableArray* records = [[NSMutableArray alloc] init];
...
#####records with references: 
  - [ContactListViewController](https://github.com/dreamfactorysoftware/ios-sdk/blob/master/example-ios/SampleApp/ContactListViewController.m#L280-L284)
  - [AddressBookViewController](https://github.com/dreamfactorysoftware/ios-sdk/blob/master/example-ios/SampleApp/AddressBookViewController.m#L73-L79)

#####with filter: 
  - [AddressBookViewController](https://github.com/dreamfactorysoftware/ios-sdk/blob/master/example-ios/SampleApp/AddressBookViewController.m#L182-L223)
  - [ContactListViewController](https://github.com/dreamfactorysoftware/ios-sdk/blob/master/example-ios/SampleApp/ContactListViewController.m#L499-L537)
  - [ContactListViewController](https://github.com/dreamfactorysoftware/ios-sdk/blob/master/example-ios/SampleApp/ContactListViewController.m#L546-L584)
```Objective-C
...
#####with Ids:
  - [AddressBookViewController](https://github.com/dreamfactorysoftware/ios-sdk/blob/master/example-ios/SampleApp/AddressBookViewController.m#L233-L269)
  - [ContactListViewController](https://github.com/dreamfactorysoftware/ios-sdk/blob/master/example-ios/SampleApp/ContactListViewController.m#L642-L684)
``` Objective-C
...
#####with different identifying field:
  - [GroupAddViewController](https://github.com/dreamfactorysoftware/ios-sdk/blob/master/example-ios/SampleApp/GroupAddViewController.m#L654-L707)
``` Objective-C
...
#####getting a file:
  - [ContactViewController](https://github.com/dreamfactorysoftware/ios-sdk/blob/master/example-ios/SampleApp/ContactViewController.m#L486-L546)
``` Objective-C
...
#####creating a file / uploading an image:
  - [ContactEditViewController](https://github.com/dreamfactorysoftware/ios-sdk/blob/master/example-ios/SampleApp/ContactEditViewController.m#L557-L607)
``` Objective-C
// build rest path for request, form is:
// <url to server>/rest/files/container/application/<folder path>/filename
// here the folder path is profile_images/contactId/
...
#####getting contents of a folder:
  - [ProfileImagePickerViewController](https://github.com/dreamfactorysoftware/ios-sdk/blob/master/example-ios/SampleApp/ProfileImagePickerViewController.m#L130-L191)
``` Objective-C
// build rest path for request, form is 
...
#####creating a folder:
  - [ContactEditViewController](https://github.com/dreamfactorysoftware/ios-sdk/blob/master/example-ios/SampleApp/ContactEditViewController.m#L506-L549)
``` Objective-C
// build rest path for request, form is 
// <url to server>/rest/files/container/application/<folder path>/
// here the folder path is profile_images/contactId/
...
#####deleting a folder:
  - [ContactListViewController](https://github.com/dreamfactorysoftware/ios-sdk/blob/master/example-ios/SampleApp/ContactListViewController.m#L593-L633)
``` Objective-C
// build rest path for request, form is 
// <url to server>/rest/files/container/application/<folder path>/
// here the folder path is profile_images/contactId/

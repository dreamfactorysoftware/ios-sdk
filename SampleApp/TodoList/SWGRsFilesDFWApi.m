...
@implementation SWGRsFilesDFWApi
static NSString * basePath = @"https://next.cloud.dreamfactory.com/rest";

@synthesize queue = _queue;
@synthesize api = _api;

+(SWGRsFilesDFWApi*) apiWithHeader:(NSString*)headerValue key:(NSString*)key {
    static SWGRsFilesDFWApi* singletonAPI = nil;

    if (singletonAPI == nil) {
        singletonAPI = [[SWGRsFilesDFWApi alloc] init];
...
-(void) getContainersWithCompletionBlock:(NSNumber*) include_properties
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/rsFilesDFW", basePath];
...
-(void) getContainerWithCompletionBlock:(NSString*) container
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/rsFilesDFW/{container}/", basePath];
...
-(void) getFolderWithCompletionBlock:(NSString*) container
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/rsFilesDFW/{container}/{folder_path}/", basePath];
...
-(void) getFileWithCompletionBlock:(NSString*) container
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/rsFilesDFW/{container}/{file_path}", basePath];

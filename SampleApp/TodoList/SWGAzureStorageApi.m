...
@implementation SWGAzureStorageApi
static NSString * basePath = @"https://next.cloud.dreamfactory.com/rest";

@synthesize queue = _queue;
@synthesize api = _api;

+(SWGAzureStorageApi*) apiWithHeader:(NSString*)headerValue key:(NSString*)key {
    static SWGAzureStorageApi* singletonAPI = nil;

    if (singletonAPI == nil) {
        singletonAPI = [[SWGAzureStorageApi alloc] init];
...
-(void) getContainersWithCompletionBlock:(NSNumber*) include_properties
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/AzureStorage", basePath];
...
-(void) createContainersWithCompletionBlock:(SWGContainersRequest*) body
    ...
    if(X_HTTP_METHOD != nil)
        headerParams[@"X_HTTP_METHOD"] = X_HTTP_METHOD;
    id bodyDictionary = nil;
...
-(void) getContainerWithCompletionBlock:(NSString*) container
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/AzureStorage/{container}/", basePath];
...
-(void) getFolderWithCompletionBlock:(NSString*) container
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/AzureStorage/{container}/{folder_path}/", basePath];
...
-(void) getFileWithCompletionBlock:(NSString*) container
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/AzureStorage/{container}/{file_path}", basePath];

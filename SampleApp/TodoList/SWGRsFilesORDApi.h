...
@interface SWGRsFilesORDApi: NSObject {
...
/**
 ...
 @param X_HTTP_METHOD Override request using POST to tunnel other http request, such as DELETE.
 */
...
/**
 ...
 Pass a comma-delimited list of container names to delete. Set 'force' to true to delete all containers. Alternatively, to delete by container records or a large list of names, use the POST request with X_HTTP_METHOD = DELETE header and post containers.
...
/**
 ...
 Set 'content_only' to true to delete the folders and files contained, but not the container. Set 'force' to true to delete a non-empty container. Alternatively, to delete by a listing of folders and files, use the POST request with X_HTTP_METHOD = DELETE header and post listing.
...
/**
 ...
 Set 'content_only' to true to delete the sub-folders and files contained, but not the folder. Set 'force' to true to delete a non-empty folder. Alternatively, to delete by a listing of sub-folders and files, use the POST request with X_HTTP_METHOD = DELETE header and post listing.

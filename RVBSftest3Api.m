...
@implementation RVBSftest3Api
static NSString * basePath = @"https://next.cloud.dreamfactory.com/rest";

@synthesize queue = _queue;
@synthesize api = _api;

+(RVBSftest3Api*) apiWithHeader:(NSString*)headerValue key:(NSString*)key {
    static RVBSftest3Api* singletonAPI = nil;

    if (singletonAPI == nil) {
        singletonAPI = [[RVBSftest3Api alloc] init];

...
@implementation RVBRsFilesORDApi
static NSString * basePath = @"https://next.cloud.dreamfactory.com/rest";

@synthesize queue = _queue;
@synthesize api = _api;

+(RVBRsFilesORDApi*) apiWithHeader:(NSString*)headerValue key:(NSString*)key {
    static RVBRsFilesORDApi* singletonAPI = nil;

    if (singletonAPI == nil) {
        singletonAPI = [[RVBRsFilesORDApi alloc] init];

...
@implementation RVBRFS_AWSApi
static NSString * basePath = @"https://next.cloud.dreamfactory.com/rest";

@synthesize queue = _queue;
@synthesize api = _api;

+(RVBRFS_AWSApi*) apiWithHeader:(NSString*)headerValue key:(NSString*)key {
    static RVBRFS_AWSApi* singletonAPI = nil;

    if (singletonAPI == nil) {
        singletonAPI = [[RVBRFS_AWSApi alloc] init];

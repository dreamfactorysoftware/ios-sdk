...
@implementation RVBDynamoDBApi
static NSString * basePath = @"https://next.cloud.dreamfactory.com/rest";

@synthesize queue = _queue;
@synthesize api = _api;

+(RVBDynamoDBApi*) apiWithHeader:(NSString*)headerValue key:(NSString*)key {
    static RVBDynamoDBApi* singletonAPI = nil;

    if (singletonAPI == nil) {
        singletonAPI = [[RVBDynamoDBApi alloc] init];

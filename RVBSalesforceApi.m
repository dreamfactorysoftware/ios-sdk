...
@implementation RVBSalesforceApi
static NSString * basePath = @"https://next.cloud.dreamfactory.com/rest";

@synthesize queue = _queue;
@synthesize api = _api;

+(RVBSalesforceApi*) apiWithHeader:(NSString*)headerValue key:(NSString*)key {
    static RVBSalesforceApi* singletonAPI = nil;

    if (singletonAPI == nil) {
        singletonAPI = [[RVBSalesforceApi alloc] init];
